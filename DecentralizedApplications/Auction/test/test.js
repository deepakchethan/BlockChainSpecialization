    ...
    ***********/
    return auctionInstance.register({ from: accounts[2] })/*<CODE HERE>*/
      .then(function (result) {
        ...
        ***********/
        return accounts[0].revealWinners()/*<CODE HERE>*/
      }).then(function () {
        /**********
        TASK 14: call winners function from accounts[0] to get the winner of item id 0
        ***********/
        return accounts[0].winners(0)/*<CODE HERE>*/
      }).then(function (result) {
        /**********
        ...
        ***********/
        return accounts[0].winners(1) /*<CODE HERE>*/
      }).then(function (result) {
        /**********
        ...
        ***********/
        return accounts[3].winners(2)/*<CODE HERE>*/
      }).then(function (result) {
        /**********
